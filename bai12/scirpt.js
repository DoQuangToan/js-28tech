...
// 2 promise(nó dùng để khắc phục việc callback có quá nhiều hàm lồng vào nhau gọi là bị callbackhell)
  // var a = 10;
  ...
  // 4
    fetch("https://dummyjson.com/products")
      ...
      const fechapi= (async(api)=>{
        const response=await fetch(api);
        const data= await response.json();
        console.log(data);
      })
      fechapi("https://dummyjson.com/products")
      .then((data)=>{
        console.log(data)
      })